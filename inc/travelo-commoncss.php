...
// enqueue css
function travelo_common_custom_css(){
    
    wp_enqueue_style( 'travelo-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= travelo_opt( 'travelo_theme_color' ) != '#131313' ? travelo_opt( 'travelo_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= travelo_opt( 'travelo_book_btn_color' ) != '#131313' ? travelo_opt('travelo_book_btn_color') : '';
		$bookBtnHoverBgColor     	= travelo_opt( 'travelo_book_btn_hvr_bg_color' ) != '#131313' ? travelo_opt('travelo_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = travelo_opt( 'travelo_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = travelo_opt( 'travelo_navbar_bg_color' ) != '#082b49' ? travelo_opt( 'travelo_navbar_bg_color') : '';
		$headerTop_col     		  = travelo_opt( 'travelo_top_header_color' );

		$headerTopBg      		  = travelo_opt( 'travelo_top_header_bg_color');
		$headerBg          		  = travelo_opt( 'travelo_header_bg_color') != '#ffffff' ? travelo_opt( 'travelo_header_bg_color') : '';
		$menuColor          	  = travelo_opt( 'travelo_header_menu_color' ) != '#131313' ? travelo_opt('travelo_header_menu_color') : '';
		$menuHoverColor           = travelo_opt( 'travelo_header_menu_hover_color' ) != '#808080' ? travelo_opt('travelo_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = travelo_opt( 'travelo_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = travelo_opt( 'travelo_header_drop_menu_bg_color' ) != '#ffffff' ? travelo_opt('travelo_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = travelo_opt( 'travelo_dropdown_menu_color' ) != '#131313' ? travelo_opt('travelo_dropdown_menu_color') : '';
		$dropMenuHovColor         = travelo_opt( 'travelo_dropdown_menu_hover_color' ) != '#808080' ? travelo_opt('travelo_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = travelo_opt( 'travelo_footer_widget_bg_color' );
		$footerwHeadColor   	  = travelo_opt('travelo_footer_widget_heading_color');
		$footerwTextColor   	  = travelo_opt('travelo_footer_widget_text_color');
		$footerwanchorcolor 	  = travelo_opt('travelo_footer_widget_anchor_color') != '#ffffff' ? travelo_opt('travelo_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = travelo_opt('travelo_footer_widget_anchor_hover_color') != '#ffffff' ? travelo_opt('travelo_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = travelo_opt('travelo_fof_bg_color');
		$foftonecolor			  = travelo_opt('travelo_fof_textone_color');
		$fofttwocolor			  = travelo_opt('travelo_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = travelo_opt('travelo_footer_widget_anchor_color') != '#9e9e9e' ? travelo_opt('travelo_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .travelo_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .travelo_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'travelo-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'travelo_common_custom_css', 50 );