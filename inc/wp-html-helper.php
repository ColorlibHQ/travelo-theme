...
// image default alt
if ( ! function_exists( 'travelo_img_default_alt' ) ) {
	function travelo_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'travelo_img_tag' ) ) {
	function travelo_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = travelo_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'travelo_anchor_tag' ) ) {
	function travelo_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'travelo_heading_tag' ) ) {
	function travelo_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'travelo_paragraph_tag' ) ) {
	function travelo_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'travelo_other_tag' ) ) {
	function travelo_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'travelo_button_element ' ) ) {
	function travelo_button_element( array $args ) {
